...
interface FileUploadProps {
    value: string
    onChange(file: File, binary: string): void
    status: string
    percent: number
    abortUpload(): void
    className?: string
    ...
    return (
        <div className={props.className}>
            <div className={"upload-header"}>
                ...
                <div className={"header-description header-text"}>Logo should be square, 100px size and in png, jpeg file format.</div>
            </div>
            <div className={"upload-content"}>
                ...
                >
                    ...
                    <svg
                        ...
                        { props.status === "done"  ? 
                            <image
                                ...
                                width="80"
                            />
                        :   <svg className={"content-icon-alt"} width="29.63" height="45.93" viewBox="0 0 32 48" x="24.69" y="18.23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <rect x="17.4815" y="17.0745" width="7.40741" height="2.96296" fill="#D1E3F8"/>
                                <rect x="17.4815" y="11.1486" width="7.40741" height="2.96296" fill="#D1E3F8"/>
                                ...
                                <rect x="17.4815" y="23.0004" width="7.40741" height="2.96296" fill="#D1E3F8"/>
                            </svg>
                        }
                    </svg>
                    <div className={`${rcn('here')} content-text`}>
                        ...
                        { props.status === "done" && <span>Drag & drop here to replace</span> }
                    </div>
                    <div className={`${rcn('or')} content-text`}>- or -</div>
                    <div
                        className={`${rcn('select')} content-text`}
                        onClick={props.status === "pending" ? props.abortUpload : openFileDialog}
...
const StyledFileUpload = styled(FileUpload)`
    ...
    .circle-progress{
        stroke: ${props => props.status === "pending" ? Colors.BD1 : Colors.BG1};
    }
